...
- Schools lack projectors or screens
...
- 100% in **Burmese** — zero English required
- Color and icons carry the meaning
...
2. Sees a card with **wrong** behavior (red border, ❌)
3. **Taps the card** → flips to **correct** behavior (green border, ✅)
4. Swipes to the next card
5. Optional quiz mode: "Which one is safe?"
...
- No app store required — works on any phone browser
...
**Built with:** React 19, Vite 8, Tailwind CSS 4, Framer Motion

**Impact:**
- Deployed at `road-safety-mm.vercel.app`
- Free and open for educational use
- Teachers can use without permission
- Not for sale — built for the children of Myanmar

**Future:** Add more scenarios, quiz modes, and teacher dashboards.
