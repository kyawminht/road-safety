        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <p className="text-sm font-semibold text-white/90">Meet the Creator</p>
              <p className="text-xs text-white/40">Tap to know more</p>
            </div>
          </div>
          <motion.svg
            ...
            >
              <div className="px-5 pb-5 flex gap-4 items-start">
                ...
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-teal-500 to-teal-700 p-0.5 shrink-0 shadow-lg">
                  <div className="w-full h-full rounded-2xl bg-[#0F1A2E] overflow-hidden flex items-center justify-center">
                    <img
                      src="/creator.jpg"
                      alt="KYAW MIN HTWE"
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-base font-bold text-white">KYAW MIN HTWE</h3>
                  <p className="text-sm text-teal-400 font-medium mt-0.5">Software Engineer</p>
                  ...
                  <div className="flex gap-2 mt-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center hover:bg-[#0077B5] hover:text-white transition-colors"
                      aria-label="LinkedIn"
                    >
                      <svg className="w-4 h-4 text-white/70" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a
                      ...
                      className="w-9 h-9 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center hover:bg-teal-500 hover:text-white transition-colors"
                      aria-label="Email"
                    >
